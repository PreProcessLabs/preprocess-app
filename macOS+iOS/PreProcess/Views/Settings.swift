        ...
        ScrollView {
            VStack(alignment: .leading) {
                ...
                HStack {
                    ...
                    .fileImporter(isPresented: $isShowingHomeSelection, allowedContentTypes: [.directory], onCompletion: { result in
                        ...
                        case .success(let Fileurl):
                            ...
                            defaults.set(Fileurl.path(percentEncoded: false), forKey: "PREPROCESS_HOME")
                ...
                Text("Save recordings for (will use approximately 100 MB every hour: this can vary greatly depending on amount of context switching, your screen size etc.)")
                    ...
                    .padding()
                    .onAppear {
                        currentRetention = defaults.integer(forKey: "PREPROCESS_RETENTION")
                    }
                ...
                layout {
                    ...
                    ForEach(Array(["Forever", "30 Days", "60 Days", "90 Days"].enumerated()), id: \.offset) { index, retain in
                        Text(retain)
                            ...
                            .onTapGesture {
                                defaults.set(index * 30, forKey: "PREPROCESS_RETENTION")
                    ...
                    ForEach(Array(["30 Days", "60 Days", "90 Days"].enumerated()), id: \.offset) { index, retain in
                        Text(retain)
                            ...
                            .onTapGesture {
                                defaults.set((index + 1) * 30, forKey: "PREPROCESS_RETENTION")
                ...
                VStack(alignment: .leading) {
                    ...
                    HStack {
                        if Agent.shared.isSetup {
                            ...
                            Button(action: {
                                ...
                                let _ = keys.delete("PREPROCESS_LLM_KEY")
                    ...
                    HStack {
                        let binding = Binding<Bool>(get: {
                            ...
                            defaults.set($0, forKey: "PREPROCESS_HIDE_DOCK")
                            hideDock = $0
                    ...
                    HStack {
                        let binding = Binding<Bool>(get: {
                            ...
                            defaults.set($0, forKey: "PREPROCESS_BROWSER")
                            browserAware = $0
                        ...
                        Text("Browser awareness (Ignore Incognito and Private Browsing windows, episodes track domains)")
                            ...
                            .font(.title2)
                            .onAppear {
                                browserAware = defaults.bool(forKey: "PREPROCESS_BROWSER")
                            }
#if os(macOS)
                            .frame(width: 1000, height: 50, alignment: .leading)
#endif
